...
class Environment:
    ...
    def is_sub(self):
        return self.scope_type in LOCAL_SCOPES
...
def eval_try_catch(node: psr.TryStmt, env: Environment):
    try:
        block_scope = Environment(TRY_CATCH_SCOPE, env)
...
def eval_if_stmt(node: psr.IfStmt, env: Environment):
    ...
    block_scope = Environment(IF_ELSE_SCOPE, env)
